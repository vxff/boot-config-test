	...
	api: function() {
		$(document).on("click.site.panel", '[data-toggle="panel-fullscreen"]', function(e) {
			...
			var $this = $(this),
				$panel = $this.closest(".panel"),
				api = $panel.data("panel-api"),
				callback = $this.data("loadCallback");
			$.isFunction(window[callback]) ? api.load(window[callback]) : api.load()
		})
	},
	init: function(context) {
		$(".panel", context).each(function() {
			var $loading, $this = $(this),
				isFullscreen = !1,
				isClose = !1,
				isCollapse = !1,
				isLoading = !1,
				$fullscreen = $this.find('[data-toggle="panel-fullscreen"]'),
				$collapse = $this.find('[data-toggle="panel-collapse"]'),
				self = this;
			$this.hasClass("is-collapse") && (isCollapse = !0);
			var api = {
				load: function(callback) {
					var type = $this.data("load-type");
					type || (type = "blue-only"), $loading = $('<div class="panel-loading"><div class="loader-wrapper active"><div class="loader-layer loader-' + type + '"><div class="loader-circle-left"><div class="circle"></div></div><div class="loader-circle-gap"></div><div class="loader-circle-right"><div class="circle"></div></div></div></div></div>'), $loading.appendTo($this), $this.addClass("is-loading"), $this.trigger("loading.uikit.panel"), isLoading = !0, $.isFunction(callback) && callback.call(self, this.done)
				},
				done: function() {
				...
				showContent: function() {
					isCollapse !== !1 && ($this.removeClass("is-collapse"), $collapse.hasClass("icon-add-a") && $collapse.removeClass("icon-add-a").addClass("icon-minus"), $this.trigger("shown.uikit.panel"), isCollapse = !1)
				},
				hideContent: function() {
					isCollapse !== !0 && ($this.addClass("is-collapse"), $collapse.hasClass("icon-minus") && $collapse.removeClass("icon-minus").addClass("icon-add-a"), $this.trigger("hidden.uikit.panel"), isCollapse = !0)
				},
				toggleFullscreen: function() {
					isFullscreen ? this.leaveFullscreen() : this.enterFullscreen()
				},
				enterFullscreen: function() {
					isFullscreen !== !0 && ($this.addClass("is-fullscreen"), $fullscreen.hasClass("icon-full-screen") && $fullscreen.removeClass("icon-full-screen").addClass("icon-exit-screen"), $this.trigger("enter.fullscreen.uikit.panel"), isFullscreen = !0)
				},
				leaveFullscreen: function() {
					isFullscreen !== !1 && ($this.removeClass("is-fullscreen"), $fullscreen.hasClass("icon-exit-screen") && $fullscreen.removeClass("icon-exit-screen").addClass("icon-full-screen"), $this.trigger("leave.fullscreen.uikit.panel"), isFullscreen = !1)
				},
				toggle: function() {
