        ...
        var _alertify = {
            ...
            dialogs: {
                buttons: {
                    ...
                    ok: "<button class='btn btn-primary ok' tabindex='1'>{{ok}}</button>",
                    cancel: "<button class='btn cancel' tabindex='2'>{{cancel}}</button>"
                },
            ...
            theme: function(themeStr) {
                ...
                case "angular-material":
                    this.dialogs.buttons.ok = "<button class='btn ok md-primary md-button' tabindex='1'>{{ok}}</button>";
                    this.dialogs.buttons.cancel = "<button class='btn cancel md-button' tabindex='2'>{{cancel}}</button>";
